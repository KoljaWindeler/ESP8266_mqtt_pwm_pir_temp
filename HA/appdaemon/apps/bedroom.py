...
class bedroomWorld(hass.Hass):
    ...
    def initialize(self):
        ...
        self.set_state("sensor.dev31_button1s",state="0")
        self.listen_state(self.bedlight_off,"sensor.dev31_button1s", new = "button1s")
        self.set_state("sensor.dev32_button1s",state="0")
        self.listen_state(self.bedlight_off,"sensor.dev32_button1s", new = "button1s")
