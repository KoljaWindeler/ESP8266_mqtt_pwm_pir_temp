...
class PumpWorld(hass.Hass):
    def initialize(self):
        ...
        self.turn_off("switch.dev4_gpio_12_autostart")
        self.turn_off("switch.dev4_gpio_12")
        self.listen_state(self.start,"switch.dev4_gpio_12_autostart")

    def start(self, entity, attribute, old, new,kwargs):
        if(self.get_state("switch.dev4_gpio_12_autostart")!="on"):
