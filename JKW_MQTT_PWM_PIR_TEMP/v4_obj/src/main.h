...
static constexpr char MQTT_LIGHT_STATE_TOPIC[]   = "/PWM_light/status"; // publish state here ON / OFF
static constexpr char MQTT_LIGHT_COMMAND_TOPIC[] = "/PWM_light/switch"; // get command here ON / OFF
...
static constexpr char MQTT_LIGHT_BRIGHTNESS_STATE_TOPIC[]   = "/PWM_light/brightness";     // publish 0-99
static constexpr char MQTT_LIGHT_BRIGHTNESS_COMMAND_TOPIC[] = "/PWM_light/brightness/set"; // set value 0-99
static constexpr char MQTT_DIMM_COMMAND_TOPIC[] = "/PWM_dimm/switch";                      // get ON/OFF command here

static constexpr char MQTT_DIMM_COLOR_STATE_TOPIC[]   = "/PWM_RGB_light/color";     // publish value "0-99,0-99,0-99"
static constexpr char MQTT_COLOR_COMMAND_TOPIC[]      = "/PWM_RGB_light/color/set"; // set value "0-99,0-99,0-99"
static constexpr char MQTT_DIMM_COLOR_COMMAND_TOPIC[] = "/PWM_RGB_dimm/color/set";  // set value "0-99,0-99,0-99"

static constexpr char MQTT_DIMM_DELAY_COMMAND_TOPIC[]      = "/PWM_dimm/delay/set";      // set value
static constexpr char MQTT_DIMM_BRIGHTNESS_COMMAND_TOPIC[] = "/PWM_dimm/brightness/set"; // set value
