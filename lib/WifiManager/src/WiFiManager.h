...
const char HTTP_HEAD_LOCAL[] PROGMEM            = "<!DOCTYPE html><html lang=\"en\"><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1, user-scalable=no\"/><title>{v}</title>";
...
class WiFiManager
{
  ...
  private:
    ...
    void (*_buttonCallback)(void) = NULL;
